...
static const yytype_int8 yyrhs[] =
{
      ...
      35,    -1,    37,    -1,    36,    29,    20,    -1,    36,    29,
      26,    30,    27,    20,    -1,     7,    -1,     8,    -1,    -1,
      36,    29,    38,    22,    39,    23,    42,    -1,    40,    -1,
       8,    -1,    40,    21,    41,    -1,    41,    -1,    36,    29,
      -1,    36,    29,    26,    27,    -1,    -1,    24,    43,    44,
      45,    25,    -1,    44,    35,    -1,    -1,    45,    46,    -1,
      -1,    47,    -1,    42,    -1,    48,    -1,    49,    -1,    50,
      -1,    51,    20,    -1,    20,    -1,     3,    22,    51,    23,
      46,    -1,     3,    22,    51,    23,    46,     4,    46,    -1,
       5,    22,    51,    23,    46,    -1,     6,    20,    -1,     6,
      51,    20,    -1,    52,    19,    51,    -1,    53,    -1,    29,
      -1,    29,    26,    51,    27,    -1,    55,    54,    55,    -1,
      55,    -1,    13,    -1,    14,    -1,    15,    -1,    16,    -1,
      17,    -1,    18,    -1,    55,    56,    57,    -1,    57,    -1,
       9,    -1,    10,    -1,    57,    58,    59,    -1,    59,    -1,
      11,    -1,    12,    -1,    22,    51,    23,    -1,    52,    -1,
      60,    -1,    30,    -1,    29,    22,    61,    23,    -1,    62,
      -1,    -1,    62,    21,    51,    -1,    51,    -1
};
...
static const char *const yytname[] =
{
  ...
  "VOID", "PLUS", "MINUS", "TIMES", "DIV", "LESSTHAN", "LESSEQUAL",
  "GREATERTHAN", "GREATEREQUAL", "EQUAL", "NOTEQUAL", "ASSIGN",
  "SEMICOLON", "COMMA", "LEFTPAREN", "RIGHTPAREN", "LEFTBRACE",
  "RIGHTBRACE", "LEFTBRACKET", "RIGHTBRACKET", "ERROR", "ID", "NUM",
  "$accept", "programa", "declaracao_lista", "declaracao",
  "var_declaracao", "tipo_especificador", "fun_declaracao", "$@1",
  "params", "param_lista", "param", "composto_decl", "$@2",
  "local_declaracoes", "statement_lista", "statement", "expressao_decl",
  "selection_decl", "iteration_decl", "return_decl", "expressao", "var",
  "simples_expressao", "relacional", "soma_expressao", "soma", "termo",
  "mult", "fator", "chamada", "args", "arg_lista", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    13,    16,     8,    17,     0,     0,     0,    19,    12,
      15,    18,    22,    24,    21,     0,     0,     0,     0,     0,
...
{
      15,   -41,   -41,     3,    15,   -41,   -41,   -24,   -41,   -41,
     -41,   -19,   -41,   -20,    -4,     2,    25,    14,    20,     9,
      30,    45,   -41,   -41,    29,    48,    15,    46,   -41,   -41,
     -41,   -41,   -41,    15,   -41,    47,     6,   -19,    52,    53,
     -14,   -41,    22,   -41,    -9,   -41,   -41,   -41,   -41,   -41,
     -41,   -41,    58,    60,   -41,    32,    57,   -41,   -41,    22,
      22,   -41,    62,    54,    22,    22,   -41,    22,   -41,   -41,
     -41,   -41,   -41,   -41,   -41,   -41,    22,    22,   -41,   -41,
      22,    63,    64,   -41,   -41,   -41,    65,    59,    56,   -41,
     -41,    61,    57,   -41,    34,    34,   -41,    22,   -41,    77,
     -41,   -41,    34,   -41
};
...
{
     -41,   -41,   -41,    80,    66,   -12,   -41,   -41,   -41,   -41,
      67,    69,   -41,   -41,   -41,   -35,   -41,   -41,   -41,   -41,
     -40,   -15,   -41,   -41,    13,   -41,     8,   -41,    10,   -41,
     -41,   -41
};
...
{
      62,    12,    63,     9,    19,    11,    61,    13,    42,    38,
      15,    39,    40,    64,    19,    44,    45,    65,    16,    81,
      82,    35,     1,     2,    85,    88,    41,    89,    42,    17,
      28,    43,     1,    18,    23,    44,    45,    38,    24,    39,
      40,    68,    69,   -14,    42,    70,    71,    72,    73,    74,
      75,    44,    45,    25,    41,    27,    42,   101,    28,    99,
     100,    90,    90,    44,    45,    90,    26,   103,    78,    79,
      68,    69,    28,    31,    59,    60,    37,    84,    66,    67,
      97,   102,    83,    98,    10,    92,    94,    95,    96,    91,
      93,     0,     0,    30,    29,     0,     0,     0,     0,    34
};

static const yytype_int8 yycheck[] =
{
      40,    20,    42,     0,    16,    29,    20,    26,    22,     3,
      30,     5,     6,    22,    26,    29,    30,    26,    22,    59,
      60,    33,     7,     8,    64,    65,    20,    67,    22,    27,
      24,    25,     7,     8,    20,    29,    30,     3,    29,     5,
       6,     9,    10,    23,    22,    13,    14,    15,    16,    17,
      18,    29,    30,    23,    20,    26,    22,    97,    24,    94,
      95,    76,    77,    29,    30,    80,    21,   102,    11,    12,
       9,    10,    24,    27,    22,    22,    29,    23,    20,    19,
      21,     4,    20,    27,     4,    77,    23,    23,    23,    76,
      80,    -1,    -1,    26,    25,    -1,    -1,    -1,    -1,    33
};
...
static const yytype_uint8 yystos[] =
{
      ...
      34,    29,    20,    26,    38,    30,    22,    27,     8,    36,
      39,    40,    41,    20,    29,    23,    21,    26,    24,    42,
      41,    27,    43,    44,    35,    36,    45,    29,     3,     5,
       6,    20,    22,    25,    29,    30,    42,    46,    47,    48,
      49,    50,    51,    52,    53,    55,    57,    59,    60,    22,
      22,    20,    51,    51,    22,    26,    20,    19,     9,    10,
      13,    14,    15,    16,    17,    18,    54,    56,    11,    12,
      58,    51,    51,    20,    23,    51,    61,    62,    51,    51,
      52,    55,    57,    59,    23,    23,    23,    21,    27,    46,
      46,    51,     4,    46
};
...
#line 108 "seman.y"
    {
            ...
            insere_simbolo((yyvsp[(2) - (3)].id), (yyvsp[(1) - (3)].tipo), SIMP_VAR, 0);
        ;}
    break;
...
#line 117 "seman.y"
    {
            ...
            insere_simbolo((yyvsp[(2) - (6)].id), (yyvsp[(1) - (6)].tipo), SIMP_ARRAY, (yyvsp[(4) - (6)].num));
        ;}
    break;
...
#line 135 "seman.y"
    {
          ...
          tipo_funcao_atual = (yyvsp[(1) - (2)].tipo);
          funcao_tem_retorno = 0;
          main_tem_parametros = 0;

          ultima_funcao_eh_main =
              ((yyvsp[(1) - (2)].tipo) == TIPO_VOID && strcmp((yyvsp[(2) - (2)].id), "main") == 0);
...
#line 180 "seman.y"
    {
            ...
            insere_simbolo((yyvsp[(2) - (2)].id), (yyvsp[(1) - (2)].tipo), SIMP_PARAM, 0);
        ;}
    break;
